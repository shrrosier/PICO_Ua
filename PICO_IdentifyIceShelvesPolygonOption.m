function [ShelfID,PBOX,Ak,floating] = PICO_IdentifyIceShelvesPolygonOption(UserVar,CtrlVar,MUA,GF,PICO_opts)
...
[ShelfID,ShelfGLx,ShelfGLy,ShelfFrontx,ShelfFronty] = PICO_GetShelfID(UserVar, CtrlVar, MUA, GF, PICO_opts);
if PICO_opts.InfoLevel>10
